package org.eclipse.efbt.openregspecs.dsl.ide.contentassist;
...
public class OpenRegSpecsIdeContentProposalProvider extends IdeContentProposalProvider {
	@Inject
	private OpenRegSpecsGrammarAccess OpenRegSpecsGrammarAccess;
	...
	protected void _createProposals(RuleCall ruleCall, ContentAssistContext context,
		...
		/** if (OpenRegSpecsGrammarAccess.getGreetingRule().equals(ruleCall.getRule()) && context.getCurrentModel() != null) {
			IScope scope = scopeProvider.getScope(context.getCurrentModel(), Open_reg_specsPackage.Literals.GREETING__FROM);
