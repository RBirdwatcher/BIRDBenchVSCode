package org.eclipse.efbt.regdna.dsl.websockets
...
class RunWebSocketServer3 {
	...
	def static void main(String[] args) {
		...
		var RegdnaWebSocketServer server = new RegdnaWebSocketServer(new InetSocketAddress(host, port)) {
...
class RegdnaWebSocketServer extends WebSocketServer {
