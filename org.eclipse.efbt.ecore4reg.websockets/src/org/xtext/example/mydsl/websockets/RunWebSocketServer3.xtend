package org.eclipse.efbt.ecore4reg.dsl.websockets
...
class RunWebSocketServer3 {
	...
	def static void main(String[] args) {
		...
		var Ecore4RegWebSocketServer server = new Ecore4RegWebSocketServer(new InetSocketAddress(host, port)) {
...
class Ecore4RegWebSocketServer extends WebSocketServer {
