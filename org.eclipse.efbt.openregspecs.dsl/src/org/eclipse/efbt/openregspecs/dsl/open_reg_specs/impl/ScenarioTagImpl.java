 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.ScenarioTagImpl#getScenario <em>Scenario</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScenarioTagImpl extends TagImpl implements ScenarioTag
{
	...
	{
		return Open_reg_specsPackage.eINSTANCE.getScenarioTag();
	}
		...
		if (scenario != null && scenario.eIsProxy())
		{
			...
			if (scenario != oldScenario)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Open_reg_specsPackage.SCENARIO_TAG__SCENARIO, oldScenario, scenario));
			}
		}
		return scenario;
	}
	...
	public void setScenario(Scenario newScenario)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.SCENARIO_TAG__SCENARIO, oldScenario, scenario));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Open_reg_specsPackage.SCENARIO_TAG__SCENARIO:
