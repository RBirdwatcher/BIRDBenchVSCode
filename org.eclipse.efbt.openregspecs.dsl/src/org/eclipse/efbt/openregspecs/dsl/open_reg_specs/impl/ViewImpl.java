 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.ViewImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.ViewImpl#getOutputLayer <em>Output Layer</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.ViewImpl#getSelectionLayerSQL <em>Selection Layer SQL</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ViewImpl extends MinimalEObjectImpl.Container implements View
{
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.VIEW__NAME, oldName, name));
	}
	...
	public XClass getOutputLayer()
	{
		if (outputLayer != null && outputLayer.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Open_reg_specsPackage.VIEW__OUTPUT_LAYER, oldOutputLayer, outputLayer));
			}
		}
		return outputLayer;
	}
	...
	public void setOutputLayer(XClass newOutputLayer)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.VIEW__OUTPUT_LAYER, oldOutputLayer, outputLayer));
	}
	...
	public EList<LayerSQL> getSelectionLayerSQL()
	{
		...
		{
			selectionLayerSQL = new EObjectContainmentEList<LayerSQL>(LayerSQL.class, this, Open_reg_specsPackage.VIEW__SELECTION_LAYER_SQL);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Open_reg_specsPackage.VIEW__SELECTION_LAYER_SQL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Open_reg_specsPackage.VIEW__NAME:
				return getName();
			case Open_reg_specsPackage.VIEW__OUTPUT_LAYER:
