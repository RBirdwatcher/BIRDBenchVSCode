 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.XEnumImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XEnumImpl extends XDataTypeImpl implements XEnum
{
	...
	{
		return Open_reg_specsPackage.eINSTANCE.getXEnum();
	}
	...
	public EList<XEnumLiteral> getLiterals()
	{
		if (literals == null)
		{
			literals = new EObjectContainmentWithInverseEList<XEnumLiteral>(XEnumLiteral.class, this, Open_reg_specsPackage.XENUM__LITERALS, Open_reg_specsPackage.XENUM_LITERAL__ENUM);
		}
		return literals;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Open_reg_specsPackage.XENUM__LITERALS:
