 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.XOperationImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XOperationImpl extends XMemberImpl implements XOperation
{
	...
	{
		return Open_reg_specsPackage.eINSTANCE.getXOperation();
	}
	...
	public void setBody(String newBody)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.XOPERATION__BODY, oldBody, body));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Open_reg_specsPackage.XOPERATION__BODY:
				return getBody();
		}
