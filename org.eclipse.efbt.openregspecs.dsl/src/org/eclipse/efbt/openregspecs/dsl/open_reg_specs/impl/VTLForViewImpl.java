 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.VTLForViewImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.VTLForViewImpl#getView <em>View</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.VTLForViewImpl#getVtl <em>Vtl</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VTLForViewImpl extends MinimalEObjectImpl.Container implements VTLForView
{
	...
	{
		return Open_reg_specsPackage.eINSTANCE.getVTLForView();
	}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.VTL_FOR_VIEW__NAME, oldName, name));
	}
	...
	public View getView()
	{
		if (view != null && view.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Open_reg_specsPackage.VTL_FOR_VIEW__VIEW, oldView, view));
			}
		}
		return view;
	}
	...
	public void setView(View newView)
	{
		...
		view = newView;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.VTL_FOR_VIEW__VIEW, oldView, view));
	}
	...
	public VTLGeneratedOutputlayer getVtl()
	{
		if (vtl != null && vtl.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Open_reg_specsPackage.VTL_FOR_VIEW__VTL, oldVtl, vtl));
			}
		}
		return vtl;
	}
	...
	public void setVtl(VTLGeneratedOutputlayer newVtl)
	{
		...
		vtl = newVtl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.VTL_FOR_VIEW__VTL, oldVtl, vtl));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Open_reg_specsPackage.VTL_FOR_VIEW__NAME:
				return getName();
			case Open_reg_specsPackage.VTL_FOR_VIEW__VIEW:
				if (resolve) return getView();
				return basicGetView();
			case Open_reg_specsPackage.VTL_FOR_VIEW__VTL:
