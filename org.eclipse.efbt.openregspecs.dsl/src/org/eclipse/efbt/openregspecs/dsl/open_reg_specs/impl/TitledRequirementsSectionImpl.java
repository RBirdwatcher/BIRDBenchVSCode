 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.TitledRequirementsSectionImpl#getSections <em>Sections</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.TitledRequirementsSectionImpl#getReferencingSections <em>Referencing Sections</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.TitledRequirementsSectionImpl#getRequirementsType <em>Requirements Type</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.TitledRequirementsSectionImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TitledRequirementsSectionImpl extends RequirementsSectionImpl implements TitledRequirementsSection
{
	...
	{
		return Open_reg_specsPackage.eINSTANCE.getTitledRequirementsSection();
	}
	...
	public EList<RequirementsSection> getSections()
	{
		if (sections == null)
		{
			sections = new EObjectContainmentEList<RequirementsSection>(RequirementsSection.class, this, Open_reg_specsPackage.TITLED_REQUIREMENTS_SECTION__SECTIONS);
		}
		return sections;
	}
		...
		if (referencingSections != null && referencingSections.eIsProxy())
		{
			...
			if (referencingSections != oldReferencingSections)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Open_reg_specsPackage.TITLED_REQUIREMENTS_SECTION__REFERENCING_SECTIONS, oldReferencingSections, referencingSections));
			}
		}
	...
	public NotificationChain basicSetReferencingSections(RequirementsSectionLinkWithText newReferencingSections, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.TITLED_REQUIREMENTS_SECTION__REFERENCING_SECTIONS, oldReferencingSections, newReferencingSections);
	...
	public void setReferencingSections(RequirementsSectionLinkWithText newReferencingSections)
	{
		if (newReferencingSections != referencingSections)
		{
			...
			if (referencingSections != null)
				msgs = ((InternalEObject)referencingSections).eInverseRemove(this, Open_reg_specsPackage.REQUIREMENTS_SECTION_LINK_WITH_TEXT__LINKED_RULE_SECTION, RequirementsSectionLinkWithText.class, msgs);
			if (newReferencingSections != null)
				msgs = ((InternalEObject)newReferencingSections).eInverseAdd(this, Open_reg_specsPackage.REQUIREMENTS_SECTION_LINK_WITH_TEXT__LINKED_RULE_SECTION, RequirementsSectionLinkWithText.class, msgs);
			msgs = basicSetReferencingSections(newReferencingSections, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.TITLED_REQUIREMENTS_SECTION__REFERENCING_SECTIONS, newReferencingSections, newReferencingSections));
	}
	...
	public RequirementType getRequirementsType()
	{
		if (requirementsType != null && requirementsType.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Open_reg_specsPackage.TITLED_REQUIREMENTS_SECTION__REQUIREMENTS_TYPE, oldRequirementsType, requirementsType));
			}
		}
	...
	public void setRequirementsType(RequirementType newRequirementsType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.TITLED_REQUIREMENTS_SECTION__REQUIREMENTS_TYPE, oldRequirementsType, requirementsType));
	}
	...
	public void setTitle(String newTitle)
	{
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.TITLED_REQUIREMENTS_SECTION__TITLE, oldTitle, title));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Open_reg_specsPackage.TITLED_REQUIREMENTS_SECTION__REFERENCING_SECTIONS:
				if (referencingSections != null)
					msgs = ((InternalEObject)referencingSections).eInverseRemove(this, Open_reg_specsPackage.REQUIREMENTS_SECTION_LINK_WITH_TEXT__LINKED_RULE_SECTION, RequirementsSectionLinkWithText.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Open_reg_specsPackage.TITLED_REQUIREMENTS_SECTION__SECTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case Open_reg_specsPackage.TITLED_REQUIREMENTS_SECTION__REQUIREMENTS_TYPE:
				if (resolve) return getRequirementsType();
				return basicGetRequirementsType();
			case Open_reg_specsPackage.TITLED_REQUIREMENTS_SECTION__TITLE:
				return getTitle();
		}
