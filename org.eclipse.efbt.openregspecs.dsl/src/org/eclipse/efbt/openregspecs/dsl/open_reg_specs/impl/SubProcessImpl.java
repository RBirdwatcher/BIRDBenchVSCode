 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.SubProcessImpl#getFlowElements <em>Flow Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubProcessImpl extends ActivityImpl implements SubProcess
{
	...
	{
		return Open_reg_specsPackage.eINSTANCE.getSubProcess();
	}
	...
	public EList<FlowElement> getFlowElements()
	{
		...
		{
			flowElements = new EObjectContainmentEList<FlowElement>(FlowElement.class, this, Open_reg_specsPackage.SUB_PROCESS__FLOW_ELEMENTS);
		}
		return flowElements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Open_reg_specsPackage.SUB_PROCESS__FLOW_ELEMENTS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == FlowElementsContainer.class)
		{
			...
			{
				case Open_reg_specsPackage.SUB_PROCESS__FLOW_ELEMENTS: return Open_reg_specsPackage.FLOW_ELEMENTS_CONTAINER__FLOW_ELEMENTS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == FlowElementsContainer.class)
		{
			...
			{
				case Open_reg_specsPackage.FLOW_ELEMENTS_CONTAINER__FLOW_ELEMENTS: return Open_reg_specsPackage.SUB_PROCESS__FLOW_ELEMENTS;
				default: return -1;
			}
		}
