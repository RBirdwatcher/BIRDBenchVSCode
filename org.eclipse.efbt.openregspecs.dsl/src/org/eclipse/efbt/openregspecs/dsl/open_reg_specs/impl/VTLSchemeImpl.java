 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.VTLSchemeImpl#getExpressions <em>Expressions</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.VTLSchemeImpl#getScheme_id <em>Scheme id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VTLSchemeImpl extends MinimalEObjectImpl.Container implements VTLScheme
{
	...
	{
		return Open_reg_specsPackage.eINSTANCE.getVTLScheme();
	}
	...
	public EList<VTLTransformation> getExpressions()
	{
		if (expressions == null)
		{
			expressions = new EObjectContainmentEList<VTLTransformation>(VTLTransformation.class, this, Open_reg_specsPackage.VTL_SCHEME__EXPRESSIONS);
		}
		return expressions;
	}
	...
	public void setScheme_id(String newScheme_id)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.VTL_SCHEME__SCHEME_ID, oldScheme_id, scheme_id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Open_reg_specsPackage.VTL_SCHEME__EXPRESSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case Open_reg_specsPackage.VTL_SCHEME__SCHEME_ID:
				return getScheme_id();
		}
