 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.E2ETestScopeImpl#getScenarios <em>Scenarios</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.E2ETestScopeImpl#getLayer <em>Layer</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.E2ETestScopeImpl#getScriptTask <em>Script Task</em>}</li>
 * </ul>
 *
 * @generated
 */
public class E2ETestScopeImpl extends TestScopeImpl implements E2ETestScope
{
	...
	public EList<Scenario> getScenarios()
	{
		if (scenarios == null)
		{
			scenarios = new EObjectResolvingEList<Scenario>(Scenario.class, this, Open_reg_specsPackage.E2E_TEST_SCOPE__SCENARIOS);
		}
		return scenarios;
	}
		...
		if (layer != null && layer.eIsProxy())
		{
			...
			if (layer != oldLayer)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Open_reg_specsPackage.E2E_TEST_SCOPE__LAYER, oldLayer, layer));
			}
		}
		return layer;
	}
	...
	public void setLayer(SelectionLayer newLayer)
	{
		...
		layer = newLayer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.E2E_TEST_SCOPE__LAYER, oldLayer, layer));
	}
	...
	public ScriptTask getScriptTask()
	{
		if (scriptTask != null && scriptTask.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Open_reg_specsPackage.E2E_TEST_SCOPE__SCRIPT_TASK, oldScriptTask, scriptTask));
			}
		}
		return scriptTask;
	}
	...
	public void setScriptTask(ScriptTask newScriptTask)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.E2E_TEST_SCOPE__SCRIPT_TASK, oldScriptTask, scriptTask));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Open_reg_specsPackage.E2E_TEST_SCOPE__SCENARIOS:
				return getScenarios();
			case Open_reg_specsPackage.E2E_TEST_SCOPE__LAYER:
				if (resolve) return getLayer();
				return basicGetLayer();
			case Open_reg_specsPackage.E2E_TEST_SCOPE__SCRIPT_TASK:
