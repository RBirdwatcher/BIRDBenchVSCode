 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.VTLTransformationImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.VTLTransformationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.VTLTransformationImpl#getTransformation_id <em>Transformation id</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.VTLTransformationImpl#getOrder_in_scheme <em>Order in scheme</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VTLTransformationImpl extends MinimalEObjectImpl.Container implements VTLTransformation
{
	...
	{
		return Open_reg_specsPackage.eINSTANCE.getVTLTransformation();
	}
	...
	public void setExpression(String newExpression)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.VTL_TRANSFORMATION__EXPRESSION, oldExpression, expression));
	}
	...
	public void setDescription(String newDescription)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.VTL_TRANSFORMATION__DESCRIPTION, oldDescription, description));
	}
	...
	public void setTransformation_id(String newTransformation_id)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.VTL_TRANSFORMATION__TRANSFORMATION_ID, oldTransformation_id, transformation_id));
	}
	...
	public void setOrder_in_scheme(String newOrder_in_scheme)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.VTL_TRANSFORMATION__ORDER_IN_SCHEME, oldOrder_in_scheme, order_in_scheme));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Open_reg_specsPackage.VTL_TRANSFORMATION__EXPRESSION:
				return getExpression();
			case Open_reg_specsPackage.VTL_TRANSFORMATION__DESCRIPTION:
				return getDescription();
			case Open_reg_specsPackage.VTL_TRANSFORMATION__TRANSFORMATION_ID:
				return getTransformation_id();
			case Open_reg_specsPackage.VTL_TRANSFORMATION__ORDER_IN_SCHEME:
