 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.VTLForSelectionLayerImpl#getSelectionLayer <em>Selection Layer</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.VTLForSelectionLayerImpl#getOutputLayer <em>Output Layer</em>}</li>
 *   <li>{@link org.eclipse.efbt.openregspecs.dsl.open_reg_specs.impl.VTLForSelectionLayerImpl#getIntermediateLayer <em>Intermediate Layer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VTLForSelectionLayerImpl extends MinimalEObjectImpl.Container implements VTLForSelectionLayer
{
	 ...
	 * @ordered
	 */
	protected LayerSQL selectionLayer;
	...
	{
		return Open_reg_specsPackage.eINSTANCE.getVTLForSelectionLayer();
	}
	 ...
	 * @generated
	 */
	public LayerSQL getSelectionLayer()
	{
		if (selectionLayer != null && selectionLayer.eIsProxy())
		{
			InternalEObject oldSelectionLayer = (InternalEObject)selectionLayer;
			selectionLayer = (LayerSQL)eResolveProxy(oldSelectionLayer);
			if (selectionLayer != oldSelectionLayer)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Open_reg_specsPackage.VTL_FOR_SELECTION_LAYER__SELECTION_LAYER, oldSelectionLayer, selectionLayer));
			}
		}
	 ...
	 * @generated
	 */
	public LayerSQL basicGetSelectionLayer()
	{
		return selectionLayer;
	}
	 ...
	 * @generated
	 */
	public void setSelectionLayer(LayerSQL newSelectionLayer)
	{
		LayerSQL oldSelectionLayer = selectionLayer;
		selectionLayer = newSelectionLayer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.VTL_FOR_SELECTION_LAYER__SELECTION_LAYER, oldSelectionLayer, selectionLayer));
	}
	...
	public VTLGeneratedOutputlayer getOutputLayer()
	{
		if (outputLayer != null && outputLayer.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Open_reg_specsPackage.VTL_FOR_SELECTION_LAYER__OUTPUT_LAYER, oldOutputLayer, outputLayer));
			}
		}
		return outputLayer;
	}
	...
	public void setOutputLayer(VTLGeneratedOutputlayer newOutputLayer)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.VTL_FOR_SELECTION_LAYER__OUTPUT_LAYER, oldOutputLayer, outputLayer));
	}
	...
	public VTLGeneratedIntermediateLayer getIntermediateLayer()
	{
		if (intermediateLayer != null && intermediateLayer.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Open_reg_specsPackage.VTL_FOR_SELECTION_LAYER__INTERMEDIATE_LAYER, oldIntermediateLayer, intermediateLayer));
			}
		}
	...
	public void setIntermediateLayer(VTLGeneratedIntermediateLayer newIntermediateLayer)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Open_reg_specsPackage.VTL_FOR_SELECTION_LAYER__INTERMEDIATE_LAYER, oldIntermediateLayer, intermediateLayer));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Open_reg_specsPackage.VTL_FOR_SELECTION_LAYER__SELECTION_LAYER:
				if (resolve) return getSelectionLayer();
				return basicGetSelectionLayer();
			case Open_reg_specsPackage.VTL_FOR_SELECTION_LAYER__OUTPUT_LAYER:
				if (resolve) return getOutputLayer();
				return basicGetOutputLayer();
			case Open_reg_specsPackage.VTL_FOR_SELECTION_LAYER__INTERMEDIATE_LAYER:
	...
	public void eSet(int featureID, Object newValue)
	{
		...
		{
			case Open_reg_specsPackage.VTL_FOR_SELECTION_LAYER__SELECTION_LAYER:
				setSelectionLayer((LayerSQL)newValue);
				return;
			case Open_reg_specsPackage.VTL_FOR_SELECTION_LAYER__OUTPUT_LAYER:
	...
	public void eUnset(int featureID)
	{
		...
		{
			case Open_reg_specsPackage.VTL_FOR_SELECTION_LAYER__SELECTION_LAYER:
				setSelectionLayer((LayerSQL)null);
				return;
			case Open_reg_specsPackage.VTL_FOR_SELECTION_LAYER__OUTPUT_LAYER:
