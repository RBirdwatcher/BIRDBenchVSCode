package org.eclipse.efbt.openregspecs.dsl.websockets
...
class RunWebSocketServer3 {
	...
	def static void main(String[] args) {
		...
		var OpenRegSpecsWebSocketServer server = new OpenRegSpecsWebSocketServer(new InetSocketAddress(host, port)) {
...
class OpenRegSpecsWebSocketServer extends WebSocketServer {
