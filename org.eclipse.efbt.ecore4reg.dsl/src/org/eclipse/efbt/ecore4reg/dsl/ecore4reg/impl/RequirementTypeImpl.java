 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.RequirementTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequirementTypeImpl extends MinimalEObjectImpl.Container implements RequirementType
{
	...
	{
		return Ecore4regPackage.eINSTANCE.getRequirementType();
	}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.REQUIREMENT_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Ecore4regPackage.REQUIREMENT_TYPE__NAME:
				return getName();
		}
