 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.ELAttributeImpl#isID <em>ID</em>}</li>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.ELAttributeImpl#getEAttributeType <em>EAttribute Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ELAttributeImpl extends ELStructuralFeatureImpl implements ELAttribute
{
	...
	public void setID(boolean newID)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.EL_ATTRIBUTE__ID, oldID, iD));
	}
	...
	public ELDataType getEAttributeType()
	{
		if (eAttributeType != null && eAttributeType.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore4regPackage.EL_ATTRIBUTE__EATTRIBUTE_TYPE, oldEAttributeType, eAttributeType));
			}
		}
	...
	public void setEAttributeType(ELDataType newEAttributeType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.EL_ATTRIBUTE__EATTRIBUTE_TYPE, oldEAttributeType, eAttributeType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Ecore4regPackage.EL_ATTRIBUTE__ID:
				return isID();
			case Ecore4regPackage.EL_ATTRIBUTE__EATTRIBUTE_TYPE:
