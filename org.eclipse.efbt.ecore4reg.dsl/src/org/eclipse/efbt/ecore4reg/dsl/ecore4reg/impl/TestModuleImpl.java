 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.TestModuleImpl#getTests <em>Tests</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestModuleImpl extends ModuleImpl implements TestModule
{
	...
	{
		return Ecore4regPackage.eINSTANCE.getTestModule();
	}
	...
	public EList<Test> getTests()
	{
		if (tests == null)
		{
			tests = new EObjectContainmentEList<Test>(Test.class, this, Ecore4regPackage.TEST_MODULE__TESTS);
		}
		return tests;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Ecore4regPackage.TEST_MODULE__TESTS:
