...
import org.eclipse.efbt.ecore4reg.dsl.ecore4reg.Comparitor;
...
public class Ecore4regFactoryImpl extends EFactoryImpl implements Ecore4regFactory
{
	...
	public EObject create(EClass eClass)
	{
		...
		{
			case Ecore4regPackage.SEQUENCE_FLOW: return createSequenceFlow();
			case Ecore4regPackage.TASK: return createTask();
			case Ecore4regPackage.EXCLUSIVE_GATEWAY: return createExclusiveGateway();
			case Ecore4regPackage.INCLUSIVE_GATEWAY: return createInclusiveGateway();
			case Ecore4regPackage.PARALLEL_GATEWAY: return createParallelGateway();
			case Ecore4regPackage.SERVICE_TASK: return createServiceTask();
			case Ecore4regPackage.SUB_PROCESS: return createSubProcess();
			case Ecore4regPackage.SCRIPT_TASK: return createScriptTask();
			case Ecore4regPackage.USER_TASK: return createUserTask();
			...
			case Ecore4regPackage.VIEW: return createView();
			case Ecore4regPackage.LAYER_SQL: return createLayerSQL();
			case Ecore4regPackage.SELECT_CLAUSE: return createSelectClause();
			...
			case Ecore4regPackage.WHERE_CLAUSE: return createWhereClause();
			case Ecore4regPackage.VIEW_MODULE: return createViewModule();
			case Ecore4regPackage.ACTIVITY_TAG: return createActivityTag();
			case Ecore4regPackage.SCENARIO: return createScenario();
			case Ecore4regPackage.SCENARIO_TAG: return createScenarioTag();
			case Ecore4regPackage.TEST: return createTest();
			case Ecore4regPackage.TEST_MODULE: return createTestModule();
			case Ecore4regPackage.DATA_CONSTRAINT: return createDataConstraint();
			case Ecore4regPackage.SELECTION_LAYER: return createSelectionLayer();
			case Ecore4regPackage.TEST_SCOPE: return createTestScope();
			case Ecore4regPackage.UNIT_TEST_SCOPE: return createUnitTestScope();
			case Ecore4regPackage.E2E_TEST_SCOPE: return createE2ETestScope();
			case Ecore4regPackage.INPUT_FILE: return createInputFile();
			case Ecore4regPackage.WORKFLOW_MODULE: return createWorkflowModule();
	...
	public Object createFromString(EDataType eDataType, String initialValue)
	{
		switch (eDataType.getClassifierID())
		{
			...
			case Ecore4regPackage.ATTR_COMPARISON:
	 ...
	 * @generated
	 */
	public org.eclipse.efbt.ecore4reg.dsl.ecore4reg.Module createModule()
	{
