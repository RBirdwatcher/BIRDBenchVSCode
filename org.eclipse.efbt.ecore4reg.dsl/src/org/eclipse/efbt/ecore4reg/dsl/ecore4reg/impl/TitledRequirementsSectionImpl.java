 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.TitledRequirementsSectionImpl#getSections <em>Sections</em>}</li>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.TitledRequirementsSectionImpl#getReferencingSections <em>Referencing Sections</em>}</li>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.TitledRequirementsSectionImpl#getRequirementsType <em>Requirements Type</em>}</li>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.TitledRequirementsSectionImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TitledRequirementsSectionImpl extends RequirementsSectionImpl implements TitledRequirementsSection
{
	...
	public EList<RequirementsSection> getSections()
	{
		if (sections == null)
		{
			sections = new EObjectContainmentEList<RequirementsSection>(RequirementsSection.class, this, Ecore4regPackage.TITLED_REQUIREMENTS_SECTION__SECTIONS);
		}
		return sections;
	}
		...
		if (referencingSections != null && referencingSections.eIsProxy())
		{
			...
			if (referencingSections != oldReferencingSections)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore4regPackage.TITLED_REQUIREMENTS_SECTION__REFERENCING_SECTIONS, oldReferencingSections, referencingSections));
			}
		}
	...
	public NotificationChain basicSetReferencingSections(RequirementsSectionLinkWithText newReferencingSections, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ecore4regPackage.TITLED_REQUIREMENTS_SECTION__REFERENCING_SECTIONS, oldReferencingSections, newReferencingSections);
	...
	public void setReferencingSections(RequirementsSectionLinkWithText newReferencingSections)
	{
		if (newReferencingSections != referencingSections)
		{
			...
			if (referencingSections != null)
				msgs = ((InternalEObject)referencingSections).eInverseRemove(this, Ecore4regPackage.REQUIREMENTS_SECTION_LINK_WITH_TEXT__LINKED_RULE_SECTION, RequirementsSectionLinkWithText.class, msgs);
			if (newReferencingSections != null)
				msgs = ((InternalEObject)newReferencingSections).eInverseAdd(this, Ecore4regPackage.REQUIREMENTS_SECTION_LINK_WITH_TEXT__LINKED_RULE_SECTION, RequirementsSectionLinkWithText.class, msgs);
			msgs = basicSetReferencingSections(newReferencingSections, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.TITLED_REQUIREMENTS_SECTION__REFERENCING_SECTIONS, newReferencingSections, newReferencingSections));
	}
	...
	public RequirementType getRequirementsType()
	{
		if (requirementsType != null && requirementsType.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore4regPackage.TITLED_REQUIREMENTS_SECTION__REQUIREMENTS_TYPE, oldRequirementsType, requirementsType));
			}
		}
	...
	public void setRequirementsType(RequirementType newRequirementsType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.TITLED_REQUIREMENTS_SECTION__REQUIREMENTS_TYPE, oldRequirementsType, requirementsType));
	}
	...
	public void setTitle(String newTitle)
	{
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.TITLED_REQUIREMENTS_SECTION__TITLE, oldTitle, title));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Ecore4regPackage.TITLED_REQUIREMENTS_SECTION__REFERENCING_SECTIONS:
				if (referencingSections != null)
					msgs = ((InternalEObject)referencingSections).eInverseRemove(this, Ecore4regPackage.REQUIREMENTS_SECTION_LINK_WITH_TEXT__LINKED_RULE_SECTION, RequirementsSectionLinkWithText.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Ecore4regPackage.TITLED_REQUIREMENTS_SECTION__SECTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case Ecore4regPackage.TITLED_REQUIREMENTS_SECTION__REQUIREMENTS_TYPE:
				if (resolve) return getRequirementsType();
				return basicGetRequirementsType();
			case Ecore4regPackage.TITLED_REQUIREMENTS_SECTION__TITLE:
				return getTitle();
		}
