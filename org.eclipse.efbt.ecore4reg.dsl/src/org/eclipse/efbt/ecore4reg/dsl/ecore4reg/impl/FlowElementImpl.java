 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.FlowElementImpl#getDisplay_name <em>Display name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class FlowElementImpl extends BaseElementImpl implements FlowElement
{
	...
	{
		return Ecore4regPackage.eINSTANCE.getFlowElement();
	}
	...
	public void setDisplay_name(String newDisplay_name)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.FLOW_ELEMENT__DISPLAY_NAME, oldDisplay_name, display_name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Ecore4regPackage.FLOW_ELEMENT__DISPLAY_NAME:
