 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.TestImpl#getInputData <em>Input Data</em>}</li>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.TestImpl#getExpectedResult <em>Expected Result</em>}</li>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.TestImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.TestImpl#getScope <em>Scope</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestImpl extends MinimalEObjectImpl.Container implements Test
{
	...
	{
		return Ecore4regPackage.eINSTANCE.getTest();
	}
	...
	public EList<InputFile> getInputData()
	{
		if (inputData == null)
		{
			inputData = new EObjectContainmentEList<InputFile>(InputFile.class, this, Ecore4regPackage.TEST__INPUT_DATA);
		}
		return inputData;
	}
	...
	public EList<InputFile> getExpectedResult()
	{
		...
		{
			expectedResult = new EObjectContainmentEList<InputFile>(InputFile.class, this, Ecore4regPackage.TEST__EXPECTED_RESULT);
		}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.TEST__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetScope(TestScope newScope, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ecore4regPackage.TEST__SCOPE, oldScope, newScope);
	...
	public void setScope(TestScope newScope)
	{
		if (newScope != scope)
		{
			...
			if (scope != null)
				msgs = ((InternalEObject)scope).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Ecore4regPackage.TEST__SCOPE, null, msgs);
			if (newScope != null)
				msgs = ((InternalEObject)newScope).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Ecore4regPackage.TEST__SCOPE, null, msgs);
			msgs = basicSetScope(newScope, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.TEST__SCOPE, newScope, newScope));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case Ecore4regPackage.TEST__NAME:
				return getName();
			case Ecore4regPackage.TEST__SCOPE:
				return getScope();
		}
