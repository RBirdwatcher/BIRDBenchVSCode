 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.ELDataTypeImpl#getIndustryName <em>Industry Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ELDataTypeImpl extends ELClassifierImpl implements ELDataType
{
	...
	{
		return Ecore4regPackage.eINSTANCE.getELDataType();
	}
	...
	public void setIndustryName(String newIndustryName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.EL_DATA_TYPE__INDUSTRY_NAME, oldIndustryName, industryName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Ecore4regPackage.EL_DATA_TYPE__INDUSTRY_NAME:
