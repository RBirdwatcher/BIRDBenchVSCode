 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.AllowedTypesImpl#getAllowedTypes <em>Allowed Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AllowedTypesImpl extends MinimalEObjectImpl.Container implements AllowedTypes
{
	...
	{
		return Ecore4regPackage.eINSTANCE.getAllowedTypes();
	}
	...
	public EList<RequirementType> getAllowedTypes()
	{
		...
		{
			allowedTypes = new EObjectContainmentEList<RequirementType>(RequirementType.class, this, Ecore4regPackage.ALLOWED_TYPES__ALLOWED_TYPES);
		}
		return allowedTypes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Ecore4regPackage.ALLOWED_TYPES__ALLOWED_TYPES:
