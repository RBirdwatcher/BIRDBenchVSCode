 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.VTLForOutputLayerAndIntermediateLayerCombinationModuleImpl#getVTLForOutputLayerAndIntermediateLayerCombinations <em>VTL For Output Layer And Intermediate Layer Combinations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VTLForOutputLayerAndIntermediateLayerCombinationModuleImpl extends ModuleImpl implements VTLForOutputLayerAndIntermediateLayerCombinationModule
{
	 ...
	 * @ordered
	 */
	protected EList<VTLForOutputLayerAndIntermediateLayerCombinationModule> vTLForOutputLayerAndIntermediateLayerCombinations;
	 ...
	 * @generated
	 */
	public EList<VTLForOutputLayerAndIntermediateLayerCombinationModule> getVTLForOutputLayerAndIntermediateLayerCombinations()
	{
		if (vTLForOutputLayerAndIntermediateLayerCombinations == null)
		{
			vTLForOutputLayerAndIntermediateLayerCombinations = new EObjectContainmentEList<VTLForOutputLayerAndIntermediateLayerCombinationModule>(VTLForOutputLayerAndIntermediateLayerCombinationModule.class, this, Ecore4regPackage.VTL_FOR_OUTPUT_LAYER_AND_INTERMEDIATE_LAYER_COMBINATION_MODULE__VTL_FOR_OUTPUT_LAYER_AND_INTERMEDIATE_LAYER_COMBINATIONS);
		}
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			case Ecore4regPackage.VTL_FOR_OUTPUT_LAYER_AND_INTERMEDIATE_LAYER_COMBINATION_MODULE__VTL_FOR_OUTPUT_LAYER_AND_INTERMEDIATE_LAYER_COMBINATIONS:
				...
				getVTLForOutputLayerAndIntermediateLayerCombinations().addAll((Collection<? extends VTLForOutputLayerAndIntermediateLayerCombinationModule>)newValue);
				return;
		}
