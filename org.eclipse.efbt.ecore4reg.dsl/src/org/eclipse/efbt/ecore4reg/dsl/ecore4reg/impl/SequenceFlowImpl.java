 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.SequenceFlowImpl#getTargetRef <em>Target Ref</em>}</li>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.SequenceFlowImpl#getSourceRef <em>Source Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SequenceFlowImpl extends FlowElementImpl implements SequenceFlow
{
	...
	{
		return Ecore4regPackage.eINSTANCE.getSequenceFlow();
	}
		...
		if (targetRef != null && targetRef.eIsProxy())
		{
			...
			if (targetRef != oldTargetRef)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore4regPackage.SEQUENCE_FLOW__TARGET_REF, oldTargetRef, targetRef));
			}
		}
		return targetRef;
	}
	...
	public NotificationChain basicSetTargetRef(FlowNode newTargetRef, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ecore4regPackage.SEQUENCE_FLOW__TARGET_REF, oldTargetRef, newTargetRef);
	...
	public void setTargetRef(FlowNode newTargetRef)
	{
		if (newTargetRef != targetRef)
		{
			...
			if (targetRef != null)
				msgs = ((InternalEObject)targetRef).eInverseRemove(this, Ecore4regPackage.FLOW_NODE__INCOMING, FlowNode.class, msgs);
			if (newTargetRef != null)
				msgs = ((InternalEObject)newTargetRef).eInverseAdd(this, Ecore4regPackage.FLOW_NODE__INCOMING, FlowNode.class, msgs);
			msgs = basicSetTargetRef(newTargetRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.SEQUENCE_FLOW__TARGET_REF, newTargetRef, newTargetRef));
	}
	...
	public FlowNode getSourceRef()
	{
		if (sourceRef != null && sourceRef.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore4regPackage.SEQUENCE_FLOW__SOURCE_REF, oldSourceRef, sourceRef));
			}
		}
		return sourceRef;
	}
	...
	public NotificationChain basicSetSourceRef(FlowNode newSourceRef, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ecore4regPackage.SEQUENCE_FLOW__SOURCE_REF, oldSourceRef, newSourceRef);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSourceRef(FlowNode newSourceRef)
	{
		if (newSourceRef != sourceRef)
		{
			NotificationChain msgs = null;
			if (sourceRef != null)
				msgs = ((InternalEObject)sourceRef).eInverseRemove(this, Ecore4regPackage.FLOW_NODE__OUTGOING, FlowNode.class, msgs);
			if (newSourceRef != null)
				msgs = ((InternalEObject)newSourceRef).eInverseAdd(this, Ecore4regPackage.FLOW_NODE__OUTGOING, FlowNode.class, msgs);
			msgs = basicSetSourceRef(newSourceRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.SEQUENCE_FLOW__SOURCE_REF, newSourceRef, newSourceRef));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Ecore4regPackage.SEQUENCE_FLOW__TARGET_REF:
				if (targetRef != null)
					msgs = ((InternalEObject)targetRef).eInverseRemove(this, Ecore4regPackage.FLOW_NODE__INCOMING, FlowNode.class, msgs);
				return basicSetTargetRef((FlowNode)otherEnd, msgs);
			case Ecore4regPackage.SEQUENCE_FLOW__SOURCE_REF:
				if (sourceRef != null)
					msgs = ((InternalEObject)sourceRef).eInverseRemove(this, Ecore4regPackage.FLOW_NODE__OUTGOING, FlowNode.class, msgs);
