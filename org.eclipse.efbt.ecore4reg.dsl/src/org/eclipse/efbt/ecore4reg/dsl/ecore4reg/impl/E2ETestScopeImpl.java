 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.E2ETestScopeImpl#getScenarios <em>Scenarios</em>}</li>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.E2ETestScopeImpl#getLayer <em>Layer</em>}</li>
 *   <li>{@link org.eclipse.efbt.ecore4reg.dsl.ecore4reg.impl.E2ETestScopeImpl#getScriptTask <em>Script Task</em>}</li>
 * </ul>
 *
 * @generated
 */
public class E2ETestScopeImpl extends TestScopeImpl implements E2ETestScope
{
	...
	{
		return Ecore4regPackage.eINSTANCE.getE2ETestScope();
	}
	...
	public EList<Scenario> getScenarios()
	{
		if (scenarios == null)
		{
			scenarios = new EObjectResolvingEList<Scenario>(Scenario.class, this, Ecore4regPackage.E2E_TEST_SCOPE__SCENARIOS);
		}
		return scenarios;
	}
		...
		if (layer != null && layer.eIsProxy())
		{
			...
			if (layer != oldLayer)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore4regPackage.E2E_TEST_SCOPE__LAYER, oldLayer, layer));
			}
		}
		return layer;
	}
	...
	public void setLayer(SelectionLayer newLayer)
	{
		...
		layer = newLayer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.E2E_TEST_SCOPE__LAYER, oldLayer, layer));
	}
	...
	public ScriptTask getScriptTask()
	{
		if (scriptTask != null && scriptTask.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Ecore4regPackage.E2E_TEST_SCOPE__SCRIPT_TASK, oldScriptTask, scriptTask));
			}
		}
		return scriptTask;
	}
	...
	public void setScriptTask(ScriptTask newScriptTask)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ecore4regPackage.E2E_TEST_SCOPE__SCRIPT_TASK, oldScriptTask, scriptTask));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case Ecore4regPackage.E2E_TEST_SCOPE__SCENARIOS:
				return getScenarios();
			case Ecore4regPackage.E2E_TEST_SCOPE__LAYER:
				if (resolve) return getLayer();
				return basicGetLayer();
			case Ecore4regPackage.E2E_TEST_SCOPE__SCRIPT_TASK:
